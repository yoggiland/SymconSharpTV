...
////////////
    	protected function SetSharpTVTimerInterval()
	{
		IPS_LogMessage("SharpTV", "SetSharpTVTimerInterval calld " );
...
///////////
            ...
            public function SharpTV_getState() // not in use //UpdateTVStatus
